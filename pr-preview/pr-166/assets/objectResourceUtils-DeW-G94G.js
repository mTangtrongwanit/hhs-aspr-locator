import{a as ea}from"./devEnvironmentUtils-b2XrV2Jv.js";import{cT as Mi,nr as ta,ns as ra,c1 as Kr,cS as ia,jp as oa,c8 as Ci,bn as Ge,dt as Dt,ip as xr,bm as C,io as aa,hv as Oi,dv as Ae,hG as he,bj as Mr,fD as V,dy as ue,dx as me,nt as na,e2 as we,_ as St,f9 as sa,a3 as Cr,s as Et,cO as la,ef as Qr,ke as ca,g0 as ht,kM as mt,ai as ei,nu as da,hs as ua,ht as ha,fw as zt,kq as ma,hu as yt,ic as Ne,eW as fa,lz as pa,aA as Ri,nv as va,bS as ga,e5 as it,nw as xa,nx as Ta,du as Ft,bl as Yt,hH as Ze,hF as Gt,ny as Ii,nz as $i,aS as _a,d4 as Xt,kJ as Tr,x as m,c$ as Pi,b8 as oe,hD as Or,ii as Rr,y as G,B as Ir,bX as Li,nA as Ni,a4 as Di,a5 as ba,fz as Ve,fv as Jt,ij as Sa,aO as Ot,hd as _r,bi as Ea,d2 as ya,aL as Aa,nB as wa,ie as Fi,Q as Ma,bp as Bi,hY as zi,nC as Gi,iI as Vt,d0 as ti,d1 as Ca,da as Oa,lB as ri}from"./index-BUSRsR_G.js";import{t as lr,e as At,o as ct}from"./mat3f64-q3fE-ZOt.js";import{o as Ut,r as Ra,e as Zt}from"./mat4f64-CSKppSlJ.js";import{x as Kt,c as br,y as Ia,u as $a,q as Pa,i as jt,L as La,O as Na,E as Da}from"./BufferView-gNP8aBTv.js";import{e as Fa,f as Ba,l as ii,o as oi}from"./vec3-CBeNIRsb.js";import{n as za,s as ai}from"./vec4-fYQ3tgjL.js";import{l as Ga,n as Va,g as qe,o as Ua,h as ja,t as Ha,i as Wa}from"./DefaultMaterial_COLOR_GAMMA-BEKk04FI.js";import{r as cr}from"./resourceUtils-Dr05Ini1.js";import{t as qa}from"./NestedMap-DFQLExW6.js";import{t as ka,l as Vi}from"./Indices-k3DSL8Ph.js";import{t as Ui}from"./requestImageUtils-h3MwxAdn.js";import{I as Ya,L as Xa,t as Xe}from"./orientedBoundingBox-YUylwEj3.js";import{t as Ja,u as vt,a as Sr,i as Za,N as Me,s as X,O as ji,e as Ce,n as wt}from"./basicInterfaces-DngWxyLO.js";import{s as W}from"./Util-YTu8ot_U.js";import{s as Hi,_ as Wi,V as Ee}from"./sphere-DTP7mqt3.js";import{v as Ka}from"./lineSegment-C5KWnrj5.js";import"./plane-ONf5Ay2v.js";import{e as p}from"./VertexAttribute-BlT9lbVY.js";import{c as be,G as Fe,L as nt,D as Ue,R as ye,O as fe,X as ni,E as Qa,I as ne,t as en,_ as tn,f as rn}from"./enums-BlUEVwJR.js";import{c as ot,a as on,e as qi,d as an}from"./Texture-BmvzGv0T.js";import{H as nn}from"./InterleavedLayout-BfX6a8Wg.js";import{n as Te,a as Z,t as Qt,o as z,b as dr,r as ur}from"./NormalAttribute.glsl-CJp658H9.js";import{o as s,n as Mt}from"./interfaces-B8ge7Jg9.js";import{l as ki,S as $r,_ as Pr,h as sn,o as ln}from"./renderState-C37QfRey.js";import{a as F}from"./BindType-BmZEZMMh.js";import{o as cn,r as dn}from"./doublePrecisionUtils-B0owpBza.js";import"./quat-CfJbbkkV.js";import"./quatf64-Bdb9ZJJK.js";import"./spatialReferenceEllipsoidUtils-CDj-vjKp.js";import"./computeTranslationToOriginAndRotation-BbZXXjN6.js";import"./types-D0PSWh4d.js";function Rt(t,e=!1){return t<=Mi?e?new Array(t).fill(0):new Array(t):new Float32Array(t)}function un(t){t.vertex.code.add(s`
...
return transformWorldFromViewTL + vPositionWorldCameraRelative;
}`)}class Js extends Mt{constructor(){super(...arguments),this.transformWorldFromViewTH=C(),this.transformWorldFromViewTL=C(),this.transformViewFromCameraRelativeRS=At(),this.transformProjFromView=Zt()}}function vo(t,e){switch(e.normalType){case Z.Attribute:case Z.Compressed:t.include(Qt,e),t.varyings.add("vNormalWorld","vec3"),t.varyings.add("vNormalView","vec3"),t.vertex.uniforms.add(new Xi("transformNormalGlobalFromModel",r=>r.transformNormalGlobalFromModel),new pe("transformNormalViewFromGlobal",r=>r.transformNormalViewFromGlobal)),t.vertex.code.add(s`void forwardNormal() {
...
color.a = 1.0;
}`);break;case X.Mask:i.code.add(s`#define discardOrAdjustAlpha(color) { if (color.a < textureAlphaCutoff) { discard; } else { color.a = 1.0; } }`);break;case X.MaskBlend:t.fragment.code.add(s`#define discardOrAdjustAlpha(color) { if (color.a < textureAlphaCutoff) { discard; } }`)}}function $o(t,e){const{vertex:r,fragment:i}=t,a=e.hasColorTexture&&e.alphaDiscardMode!==X.Opaque;switch(e.output){case z.Depth:et(r,e),t.include(Qe,e),t.include(Ke,e),t.include(ze,e),a&&i.uniforms.add(new Q("tex",o=>o.texture)),r.code.add(s`void main(void) {
...
const float HALF_PI = 1.570796326794897;`)}function Hr(t,e){const r=t.fragment.code;t.include(Uo),e.pbrMode!==$.Normal&&e.pbrMode!==$.Schematic&&e.pbrMode!==$.Simplified&&e.pbrMode!==$.TerrainWithWater||(r.add(s`float normalDistribution(float NdotH, float roughness)
{
...
return c2 * a004 + r.zw;
}`)),e.pbrMode!==$.Normal&&e.pbrMode!==$.Schematic||(t.include(Kl),r.add(s`struct PBRShadingInfo
{
float NdotL;
float NdotV;
float NdotH;
...
return outColor;
}`))}let Ql=class extends ee{constructor(e,r){super(e,"bool",F.Pass,(i,a,o)=>i.setUniform1b(e,r(a,o)))}};const ec=.4;function Wr(t){t.constants.add("ambientBoostFactor","float",ec)}function qr(t){t.uniforms.add(new se("lightingGlobalFactor",(e,r)=>r.lighting.globalFactor))}function jo(t,e){const r=t.fragment;switch(t.include(Ur,e),e.pbrMode!==$.Disabled&&t.include(Hr,e),t.include(Zl,e),t.include(Uo),r.code.add(s`
...
}`),e.pbrMode){case $.Disabled:case $.WaterOnIntegratedMesh:case $.Water:t.include(Ai),r.code.add(s`vec3 evaluateSceneLighting(vec3 normalWorld, vec3 albedo, float shadow, float ssao, vec3 additionalLight)
{
...
inputs.averageAmbientRadiance = ambientLightIrradianceComponent[1] * (1.0 + GROUND_REFLECTANCE[1]);`),r.code.add(s`
    ...
    `);break;case $.Simplified:case $.TerrainWithWater:t.include(Ai),r.code.add(s`const float roughnessTerrain = 0.5;
...
return outColor;
}`);break;default:yt(e.pbrMode);case $.COUNT:}}function Ho(t,e){if(!e.multipassEnabled)return;t.fragment.include(Vr),t.fragment.uniforms.add(new Q("terrainDepthTexture",(i,a)=>a.multipassTerrain.depth?.attachment));const r=e.occlusionPass;t.fragment.code.add(s`
